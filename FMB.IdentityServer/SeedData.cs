...
namespace FMB.IdentityServer
{
    public class SeedData
    {
        ...
        private static void EnsureUsers(IServiceScope scope)
        {
            ...
            var angella = userMgr.FindByNameAsync("gordon").Result;
            if (angella == null)
            {
                ...
                result =
                    userMgr.AddClaimsAsync(
                        ...
                        new Claim[]
                        {
                            new Claim(JwtClaimTypes.Name, "Gordon Freeman"),
                            new Claim(JwtClaimTypes.GivenName, "Gordon"),
                            new Claim(JwtClaimTypes.FamilyName, "Freeman"),
                            new Claim(JwtClaimTypes.WebSite, "http://gordonfreeman.com"),
